...
export default function HostPage() {
  ...
  async function update(action: 'reset' | 'question' | 'open' | 'visibility' | 'ended') {
    setBusy(true); setMessage('');
    try { await mutate({ action, question: draft, open: !data?.open, visible: !data?.showAnswers, ended: !data?.ended }); setConfirm(false); setEditing(false); setToolsOpen(false); }
